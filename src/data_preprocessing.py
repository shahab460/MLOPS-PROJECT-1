...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            logger.info("Dropping the column")
            ...
            logger.error(f"Error during preprocess steps {e}")
    ...
    def balance_data(self, df):
        try:
            ...
            logger.info("Data balance complete")
            return balanced_df
        
        except Exception as e:
            logger.error(f"Error during balancing data steps {e}")
    ...
    def select_features(self, df):
        try:
            ...
            top_n_features = top_feature_importance_df["feature"].head(num_features_to_select).values
            logger.info(f"Features selected : {top_n_features}")
    ...
    def save_data(self, df, file_path):
        try:
            ...
            logger.info("Data saved successfully to given file path {file_path}")
    ...
    def process(self):
        try:
            ...
            logger.info("Data Processing complete successfully")
