...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            logger.info(f"Starting to load data from {self.train_path}")
            ...
            logger.error(f"Error during loading and split data {e}")
            raise CustomException("Error during loading and split data", e)
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            raise CustomException("Error during training the model", e)
        
    def evaluate_model(self, model, X_test, y_test):
        try:
            logger.info("Starting to evaluate the model")
            ...
            logger.error(f"Error during evaluating the model {e}")
            raise CustomException("Error during evaluating the model", e)
    ...
    def save_model(self, model):
        try:
            ...
            logger.info(f"Model saved to {self.model_output_path} successfully")
